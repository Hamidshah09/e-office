...
<div class="container fluid">
    ...
    <button class="btn btn-primary" id ="removeButton"> Incorrectly Marked</button>
    <button class="btn btn-primary" id ="returnButton">Incorroectly sended</button>
    <form action="{{route("recall")}}" method="post" id="sent-grid">
      @csrf
    <input id="request_type" type="hidden" name="request_type" value="Return">
  ...
  if (maincheck.checked ==true){
    ...
    removeButton.onclick = function(){
      ...
      if(checkedBoxes.length==0){
          ...
          document.getElementById('request_type').value= "Remove";
          document.getElementById('sent-grid').submit();
        }
