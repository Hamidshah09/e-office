...
<div class="container fluid">
  ...
  <form action="{{route('section.update', $section->id)}}" method="POST">
    @csrf
    @method('PUT')
    <h4 class="font-strong heading-tab my-4">Edit Section/Department</h5>
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          <label class="form-label" for="">Section/Department Name</label>
          <input type="text" id="section" name="section" value="{{$section->section}}" class="form-control" minlength="3" maxlength="60" required="required">
        </div>
      </div>  
    </div>
    <div class="row">
