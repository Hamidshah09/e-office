...
<div class="container fluid">
  ...
  <form action="{{route('files.store')}}" method="POST">
    @csrf
    <h4 class="font-strong heading-tab my-4">New File</h5>
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          <label class="form-label" for="">File No.</label>
          <input type="text" id="file_no" name="file_no" value="" class="form-control" minlength="3" maxlength="255" required="required">
        </div>
      </div>

      <div class="col-sm-4">
        <div class="form-group">
          <label class="form-label" for="">File Subject</label>
          <input type="text" id="file_subject" name="file_subject" value="" class="form-control" minlength="3" maxlength="255" required="required">
        </div>
      </div>
    </div>  
    <div class="row">
